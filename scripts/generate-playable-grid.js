...
const cellWidth = 0.018;
const cellHeight = 0.012;
...
fs.writeFileSync(path.join(root, "public", "playable-grid.json"), JSON.stringify({ version: 1, count, rows }));
console.log(`Generated ${count} playable cells in ${Object.keys(rows).length} rows.`);
